      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="text-gray-400 text-sm space-y-1">
              <li>
                <a href="https://www.instagram.com/proshopbaradero/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-club-yellow transition">
              ...
              <li>
                <a href="https://wa.me/5433296164636" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-club-yellow transition">
