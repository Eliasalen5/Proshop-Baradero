        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-center">
          ...
          <div>
            ...
            <ul className="text-gray-400 text-sm space-y-1">
              ...
              <li>
                <a href="https://www.google.com/maps/search/?api=1&query=-33.80779,-59.50150" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-gray-400 text-sm hover:text-club-yellow transition">
